$(document).ready(function() {
  (function() {
    ...
    scene.add(new THREE.AmbientLight(0x666363));
    var light = new THREE.DirectionalLight(0x999999, .5);
    ...
    function createSphere(radius, segments) {
      return new THREE.Mesh(new THREE.SphereGeometry(radius, segments, segments), new THREE.MeshPhongMaterial({
        map: THREE.ImageUtils.loadTexture('https://cdn.rawgit.com/bubblin/The-Solar-System/master/images/page-55/europa.jpg'),
        bumpScale: 0.005,
